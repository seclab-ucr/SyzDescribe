...
namespace sd {
    ...
    public:
        ...
        std::unordered_map<llvm::FunctionType *, std::set<T_function *> *> map_function_type;
        ...
        int64_t get_callee(llvm::Instruction *inst, std::set<llvm::Function *> *targets,
        ...
        int64_t find_ops_structure(const std::string &ops_structure, const std::string &ops_name,
        ...
        // get path number :
        const std::set<std::string> no_path_functions = {"vsnprintf", "format_decode"};

        void get_path_number(llvm::Function *f, std::set<llvm::Function *> *call, uint64_t *path_number,
                             uint64_t *b_number);

        void get_path_number(llvm::BasicBlock *b, std::set<llvm::BasicBlock *> *path, uint64_t *path_number);
