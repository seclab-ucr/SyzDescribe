...
namespace sd {
    ...
    public:
        ...
        // index of the driver or device structure object in argument or return value(-1)
        int64_t object{};
        ...
        int64_t value{};
        // (optical) if the value is a field of the argument, the index is variable offset
        // e.g. func(arg): arg->var is the value
        int64_t offset{};
    ...
    public:
        ...
        virtual int64_t find_k_variable(const std::string &structure1, int64_t offset, K_variable **k);
    ...
    public:
        ...
        int64_t find_k_variable(const std::string &structure1, int64_t offset, K_variable **k) override;
    };
    ...
    public:
        ...
        void make_checker(checker_type type, K_base *kb, K_variable *kv, uint64_t id = 0);
        ...
        int64_t add_knowledge(sd::checker_result *cr, std::string key_dereference_obj_name,
                              int64_t key_dereference_obj_open);

        int64_t find_k_variable(const std::string &structure, int64_t offset, K_variable **k);
    };
}
